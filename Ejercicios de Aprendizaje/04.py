...
def analizarPalabras():
    ...
    if palabra1 == palabra1[::-1]:
        print(f"La palabra {palabra1} es palíndroma")
    else:
        print(f"La palabra {palabra1} no es palíndroma")

    if palabra1 == palabra2[::-1]:
        print(f"La palabra {palabra2} es palíndroma")
    else:
        print(f"La palabra {palabra2} no es palíndroma")
    ...
    def isograma():
        ...
        for caracter in palabra1:
            if palabra1.count(caracter) == 1 or palabra1.count(caracter) == 2 or palabra1.count(caracter) == 3:
                es_isograma1 = True

        for caracter in palabra2:
            if palabra1.count(caracter) == 1 or palabra2.count(caracter) == 2 or palabra2.count(caracter) == 3:
                es_isograma2 = True

        if es_isograma1 == True:
            print(f"La palabra {palabra1} es un Isograma")
        else:
            print(f"La palabra {palabra1} no es un Isograma")

        if es_isograma2 == True:
